...
<html lang="en">
  <head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="/fragrancefusion/css/signup.css">
<link rel="stylesheet" href="/fragrancefusion/css/headerfooter.css">
    ...
    <div class="container">
      <header class="header">
        <div class="header-left">
          <a href="/index.html" class="logo">FRAGRANCE FUSION</a>
          <nav class="main-nav">
            <a href="collections.html" class="nav-link">Collections</a>
            <a href="AboutUs.html" class="nav-link">About</a>
            <a href="ContactForm.html" class="nav-link">Contact</a>
...
<div class="signup-page d-flex justify-content-center align-items-center vh-100">
  <div class="card p-4 shadow" style="width: 100%; max-width: 500px;">
    ...
    <form action="/fragrancefusion/html/submit_signup.php" method="POST">
      <div class="mb-3">
        ...
        <div class="footer-column">
          <div class="footer-section">
            ...
            <nav class="footer-nav">
              ...
              <a href="/html/FAQ.html" class="footer-link">FAQ</a>
            </nav>
