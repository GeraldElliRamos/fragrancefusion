...
// Fetch male Parfum De Extrait products from the database
$category = 'parfum de extrait';
$gender = 'male';
...
<head>
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="../css/collections3.css">
    <style>
        .cart-link {
            position: relative;
...
<div class="container mt-5">
    <h1 class="text-center modern-heading">Male Fragrances - Eau De Extrait</h1>
        ...
        function addToCart(productData) {
            ...
            if (isLoggedIn) {
                ...
                try {
                    ...
                    // Calculate new cart count and update IMMEDIATELY (not in setTimeout)
