...
<body>
    ...
    <div class="container modern-container">
        ...
        <div class="modern-grid men-women">
            <div class="modern-card" onclick="redirectTo('../html/tomford.php')">
            ...
            <div class="modern-card" onclick="redirectTo('../html/cocomademoiselle1.php')">
