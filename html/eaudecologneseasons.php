...
<body>
    ...
    <div class="container modern-container">
        ...
        <div class="modern-grid men-women">
            <div class="modern-card" onclick="redirectTo('../html/calvinklein.php')">
            ...
            <div class="modern-card" onclick="redirectTo('../html/chanel.php')">
