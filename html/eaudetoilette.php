...
<body>
    ...
    <div class="container modern-container">
        ...
        <div class="modern-grid men-women">
            <div class="modern-card" onclick="redirectTo('../html/oranzo.php')">
            ...
            <div class="modern-card" onclick="redirectTo('../html/daisy.php')">
